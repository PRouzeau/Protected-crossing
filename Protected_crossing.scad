...
//== ERRORS =======================
// a mettre en oeuvre
er_1lane_sep = "Error!: You can't set a pavement separation within\n direction when there is only one lane\n, this prevent trucks and busses to turn:\n";
//fr::er_1lane_sep = "Erreur!: vous ne pouvez pas mettre de séparateur béton quand l'entrée n'a qu'une seule voie, ceci empêche les bus et les camions de tourner:";

er_pavalleypark = "Error!: when a parking lane is located aside a alley pavement separation, this separation shall be at least 0.6m wide for proper car loading/unloading and protection of alley users, actual pavement width is:";
//fr::er_pavalleypark = "Erreur!: quand une voie de parking est située a coté d'un trottoir de séparation d'une allée, ce trottoir doit faire au moins 0.6m de large pour un chargement/déchargement correct des voitures et pour la protection des usagers de l'allée. Largeur actuelle du trottoir:";
